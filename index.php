...
//Set gmail password
	$mail->Password = "Nileshwari@123";
//Email subject
	$mail->Subject = "Test email using PHPMailer";
//Set sender email
	$mail->setFrom("test.nileshwari@gmail.com");
//Enable HTML
	$mail->isHTML(true);
//Email body
	$mail->Body = "This is a plain text email body";
//Add recipient
	$mail->addAddress("ganeshpatil.1997@gmail.com");
//Finally send email
	if ( $mail->send() ) {
		echo "Email Sent..!";
	}else{
...
<body>
    ...
    <footer>
        <p class="copyright-agileinfo"> &copy; 2021. All Rights Reserved | Design by <a href="https://www.linkedin.com/in/sedulous-ganesh/">Ganesh Patil</a></p>
    </footer>
